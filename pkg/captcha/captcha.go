...
func (class *Captcha) GenerateCaptcha() (id string, b64s string, err error) {
	return class.Base64Captcha.Generate()
}

// VerifyCaptcha 验证验证码是否正确
func (class *Captcha) VerifyCaptcha(id string, answer string) (match bool) {
	...
	return class.Base64Captcha.Verify(id, answer, false)
}
